...
export default function BottleShowcase() {
  ...
  return (
    <div
      ref={triggerRef}
      className="w-full bg-slate-50/50 relative border-b border-slate-100 overflow-hidden"
    >
      {/* Decorative gradient spot at background */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-mint-green/5 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none px-4 z-0">
          <h2 className="showcase-bg-heading font-display font-extrabold text-4xl sm:text-5xl md:text-8xl lg:text-9xl text-transparent bg-clip-text bg-gradient-to-r from-navy-dark/10 via-teal-glow/15 to-mint-green/10 uppercase tracking-tighter text-center leading-none">
            APOTEK
            <br />
            MASA DEPAN
          </h2>
        ...
        <div className="w-full max-w-5xl mx-auto h-[500px] md:h-[600px] relative flex items-center justify-center showcase-content">
          ...
          {/* Feature 1 - Left */}
          <div className="callout-1 showcase-animated-element absolute left-2 sm:left-6 md:left-12 top-[10%] sm:top-[20%] md:top-[25%] z-20 max-w-[170px] sm:max-w-[240px] md:max-w-xs p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white/90 backdrop-blur-md border border-emerald-50 shadow-[0_8px_30px_rgba(0,0,0,0.04)] flex items-start gap-2 sm:gap-3">
            ...
            <div className="space-y-0.5 sm:space-y-1">
              <h4 className="font-display font-bold text-navy-dark text-[11px] sm:text-xs md:text-sm">
                Obat 100% Original
              </h4>
              <p className="text-[9px] sm:text-[10px] md:text-xs text-slate-500 font-light leading-relaxed">
          ...
          {/* Feature 2 - Right */}
          <div className="callout-2 showcase-animated-element absolute right-2 sm:right-6 md:right-12 top-[40%] sm:top-[42%] md:top-[40%] z-20 max-w-[170px] sm:max-w-[240px] md:max-w-xs p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white/90 backdrop-blur-md border border-teal-50 shadow-[0_8px_30px_rgba(0,0,0,0.04)] flex items-start gap-2 sm:gap-3">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-teal-50 text-teal-glow flex items-center justify-center shrink-0">
          ...
          <div className="callout-3 showcase-animated-element absolute left-4 sm:left-[15%] md:left-[20%] bottom-[4%] sm:bottom-[8%] md:bottom-[12%] z-20 max-w-[170px] sm:max-w-[240px] md:max-w-xs p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white/90 backdrop-blur-md border border-indigo-50 shadow-[0_8px_30px_rgba(0,0,0,0.04)] flex items-start gap-2 sm:gap-3">
            ...
            <div className="space-y-0.5 sm:space-y-1">
              ...
              <p className="text-[9px] sm:text-[10px] md:text-xs text-slate-500 font-light leading-relaxed font-sans">
        ...
        <div className="absolute bottom-6 flex flex-col items-center gap-1.5 opacity-80 pointer-events-none z-10 text-center animate-pulse">
          ...
          <div className="w-5 h-8 sm:w-6 sm:h-10 rounded-full border-2 border-slate-300 flex justify-center p-1">
