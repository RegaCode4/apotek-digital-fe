...
export default function About() {
  ...
  return (
    <section id="tentang" className="py-20 md:py-28 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between p-8 md:p-10 rounded-[32px] bg-gradient-to-br from-slate-50 to-emerald-50/10 border border-slate-100 shadow-sm relative overflow-hidden group">
            ...
            <SectionReveal className="space-y-6">
              ...
              <h3 className="text-2xl sm:text-3xl font-display font-bold text-navy-dark leading-tight">
              ...
              <div className="pt-4 flex flex-wrap gap-3">
                <span className="text-xs font-semibold bg-white border border-slate-100 text-slate-600 px-3 py-1.5 rounded-xl shadow-xs">
          ...
          <div className="lg:col-span-5 grid grid-cols-1 gap-6">
            ...
            <SectionReveal delay={0.1}>
              <div className="p-6 rounded-2xl bg-white border border-slate-150 shadow-sm hover:border-mint-green/30 transition-all flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-emerald-50 flex items-center justify-center text-teal-glow shrink-0">
                  <Clock className="w-6 h-6" />
                </div>
                <div className="space-y-1">
                  <h4 className="font-display font-bold text-navy-dark text-base">Jam Operasional Layanan</h4>
                  <p className="text-xs font-semibold text-teal-glow uppercase tracking-wider">Senin - Jumat</p>
                  <p className="text-sm text-slate-600">{pharmacyProfile.operatingHours.weekday}</p>
                  <p className="text-xs font-semibold text-teal-glow uppercase tracking-wider pt-1.5">Sabtu - Minggu</p>
                  <p className="text-sm text-slate-600">{pharmacyProfile.operatingHours.weekend}</p>
                  <p className="text-[11px] text-orange-500 font-medium italic mt-2 block">{pharmacyProfile.operatingHours.notes}</p>
                </div>
              </div>
            </SectionReveal>
            ...
            <SectionReveal delay={0.2}>
              <div className="p-6 rounded-2xl bg-white border border-slate-150 shadow-sm hover:border-mint-green/30 transition-all flex items-start gap-4">
                ...
                <div className="space-y-1">
                  <h4 className="font-display font-bold text-navy-dark text-base">Lokasi Fisik Apotek</h4>
            ...
            <SectionReveal delay={0.3}>
              <div className="p-6 rounded-2xl bg-white border border-slate-150 shadow-sm hover:border-mint-green/30 transition-all flex items-start gap-4">
                ...
                <div className="space-y-1">
                  <h4 className="font-display font-bold text-navy-dark text-base">Kontak Hubungan Layanan</h4>
                  <p className="text-xs font-semibold text-teal-glow uppercase tracking-wider">WhatsApp Resmi</p>
                  <a
                    href="https://wa.me/6282278954406"
                    target="_blank"
                    rel="noreferrer"
                    className="text-sm text-slate-600 hover:text-teal-glow hover:underline font-bold block"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, idx) => {
            ...
            return (
              <div key={idx}>
                <SectionReveal delay={idx * 0.1} className="flex flex-col p-6 rounded-2xl bg-slate-50/50 border border-slate-100 hover:bg-white hover:shadow-md transition-all duration-300">
                  ...
                  <h4 className="font-display font-bold text-base text-navy-dark mb-2">{feature.title}</h4>
                  <p className="text-sm text-slate-500 leading-relaxed font-light">{feature.text}</p>
                </SectionReveal>
              </div>
            );
          })}
